  ...
  window['HTMLElement'] =
      (function() {
        function HTMLElement(this: HTMLElement) {
          ...
          const definition = internals.constructorToDefinition(
              constructor as {new (): HTMLElement});
          if (!definition) {
            throw new Error(
          ...
          if (constructionStack.length === 0) {
            const element =
                /** @type {!HTMLElement} */ (Native.Document_createElement.call(
                    document, definition.localName));
